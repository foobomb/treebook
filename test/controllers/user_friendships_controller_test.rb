...
class UserFriendshipsControllerTest < ActionController::TestCase
  ...
  context "#index"  do
    ...
    context "when logged in" do
      ...
      should "display accepted information on a friendship" do
      ...
      context "blocked users" do
        ...
        should "display blocked friend's names" do
  ...
  context "#new"  do
    ...
    context "when logged in" do
      ...
      should "return a 404 if no friend found" do
  ...
  context "#accept" do
    ...
    context "when logged in" do
      ...
      should "have flash message success" do
